Meteor.startup ->
 Collections.Sessions.after.insert (userId, doc, fieldNames, modifier, options) ->
   ...
   lastSession = Collections.Sessions.findOne {courseId: doc.courseId}, sort: date: -1

   # Update the course last session
   Collections.Courses.direct.update {_id: doc.courseId}, $set: lastSession: date: lastSession.date, participantsCount: lastSession.participantsIds.length
